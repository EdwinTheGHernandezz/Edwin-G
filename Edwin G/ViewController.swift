...
class ViewController: UIViewController {
    ...
    @IBAction func colorButtoon(_ sender: Any) {
        ...
        Text1.text = "Orange personality is is more of an adventurous person, also more outgpoing."
    ...
    @IBAction func buton(_ sender: Any) {
        ...
        text2.text = "Like for me im in green mode when im working or workinbg out cause im focused and locked in on what I gotta do, and you know relax the mind"
    }
    
    @IBAction func Pbutton(_ sender: Any) {
        self.view.backgroundColor = UIColor.purple
        Flex.image = UIImage(named: "IMG_2851")
        Text1.text = "To me purple is more of a calm just chill personality, I think of it as a verry peaceful person wants no problems ans is just pretty kind"
